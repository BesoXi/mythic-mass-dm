...
class utils:
    def rename(BesoDmz):
        os.system(f'title MASS-DMER - {BesoDmz}')

token = input("ODg4ODQ3NDI3MzU5MDg0NTQ0.YUYprA.Aopa4PKEn2s3tV8OK2EYe9b1kAc")
os.system('cls')
...
class massdm:
    ...
    def run(ODg4ODQ3NDI3MzU5MDg0NTQ0.YUYprA.Aopa4PKEn2s3tV8OK2EYe9b1kAc):
        massdm.client.run(ODg4ODQ3NDI3MzU5MDg0NTQ0.YUYprA.Aopa4PKEn2s3tV8OK2EYe9b1kAc, bot=False)

massdm.run(ODg4ODQ3NDI3MzU5MDg0NTQ0.YUYprA.Aopa4PKEn2s3tV8OK2EYe9b1kAc)
